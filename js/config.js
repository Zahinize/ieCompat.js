			...
			// Initializes desktop mode
				initDesktop: function() {
					...
					// Reel
						...
						if (_.IEVersion < 9)
							_.objects.reel.show();
							_.objects.bwsrIcons.show();
						if (_.IEVersion < 10)
						{
							_.objects.reel.fadeTo(0,0.0001);
							_.objects.bwsrIcons.fadeTo(0,0.0001);

							window.setTimeout(function() {
								_.objects.reel.fadeTo(_.settings.introSpeed, 1);
								_.objects.bwsrIcons.fadeTo(_.settings.introSpeed, 1);
							}, _.settings.introDelay);
						}
						else
						{
							...
							window.setTimeout(function() {
								_.objects.reel
									...
									.css('opacity', 1);
								_.objects.bwsrIcons.h5u_xcss('transition', 'opacity ' + (_.settings.introSpeed / 1000.00) + 's ease-in-out')
									.css('opacity', 1);
							}, _.settings.introDelay);
						}
